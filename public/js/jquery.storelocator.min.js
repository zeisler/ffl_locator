...
}else{a(M).find("marker").each(function(){var Q={name:a(this).attr("name"),lat:a(this).attr("lat"),lng:a(this).attr("lng"),address:a(this).attr("address"),address2:a(this).attr("address2"),city:a(this).attr("city"),state:a(this).attr("state"),zip_code:a(this).attr("zip_code"),country:a(this).attr("country"),phone:a(this).attr("phone"),email:a(this).attr("email"),web:a(this).attr("web"),hours1:a(this).attr("hours1"),hours2:a(this).attr("hours2"),hours3:a(this).attr("hours3"),category:a(this).attr("category"),featured:a(this).attr("featured")};
